...
<body onload="loader()">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12 side-border">
                <div>
                    <div class="top-panel m-5 bg-white">
                    ...
                    <div class="content-panel m-5 mt-3">
                        <!-- top writers set here start -->
                        <div class="who-to-follow-wrapper">
                            <h2 class="who-to-follow-heading">Who to follow</h2>
                            <div class="who-to-follow-inner">

                            </div>
                        </div>
                        <!-- top writers set here end -->
                    </div>
                </div>
            </div>
                                ...
                                <div class="y">
                                    <div class="y">
                                        ...
                                        <div class="y">
                                            <!-- data set here start -->
                                            <?php
                                        $query = "SELECT `stories`.*,`user_login`.`username`, `user_login`.`name`, `user_login`.`profile` FROM `stories` INNER JOIN `user_login` ON `stories`.`user_uid` = `user_login`.`user_uid` WHERE `post_status` = 'published' AND `unlisted` = 'false' ORDER BY RAND() DESC LIMIT 3";
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.loadmoreLatestPost', function() {
            ...
            $.ajax({
                type: 'POST',
                url: 'php/loadMoreData/loadMoreAllwriter.php',
                data: {
                    row: row,
                    query: 'all-writers'
                },
                success: function(data) {
                    ...
                    $('.who-to-follow-inner').append(data);
                    if (rowCount >= count) {
