                                    ...
                                    <div class="inner-tag-container">
                                        <div class="tag-icon-name-div">
                                            <div class="tag-icon-name-inner-div">
                                                <div class="y">
                                                    <h1 class="tag-heading">Your Audience</h1>
                                                    <p class="p-0 m-0">Updated daily</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="content-panel m-lg-5 mt-3">
                        <div class="col-12">
                            <div class="d-lg-flex justify-content-between align-items-center my-4">
                                <div class="mx-4">
                                    <h4 class="fw-bold text-center">Followers</h4>
                                    <h5 class="fw-bold text-center" style="color:#1a8917">
                                        <?php echo '<span class=" follower_add">' . $follower_count . '</span> ' . ($follower_count == 1 ? '' : '') ?>
                                    </h5>
                                </div>
                                <div class="mx-4">
                                    <h4 class="fw-bold text-center">Following</h4>
                                    <h5 class="fw-bold text-center" style="color:#1a8917">
                                        <?php echo '<span class=" following_add">' . $following_count . '</span> ' . ($following_count == 1 ? '' : '') ?>
                                    </h5>
                                </div>
                                <a class="audience-button" href="user-stats">Story stats</a>
                            </div>
                            <h4 class="fw-bold text-center mt-5" style="color:var(--gray-color);">Daily Followers Stats
                            </h4>
                            <div class="col-md-12 mb-5">
                                <div id="piechart1" class="chart">
                                </div>
                            </div>
                            <h4 class="fw-bold text-center mt-5" style="color:var(--gray-color);">Monthly Followers
                                Stats</h4>
                            <div class="col-md-12 mb-5">
