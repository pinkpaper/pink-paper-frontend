                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12 col-sm-12"
                                            ...
                                            <div class="form-group" id="title">
                                                <h5 class="fw-bold text-capitalize  text-align"
                                                    style="color:var(--text-color);">
                                                    First Name</h5>
                                                <input type="text" class="form-control form-control-lg story-input"
                                                    name="fname" id="first_name" placeholder="First Name" aria-required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12"
                                            ...
                                            <div class="form-group" id="title">
                                                <h5 class="fw-bold text-capitalize  text-align"
                                                    ...
                                                    Last Name</h5>
                                                <input type="text" class="form-control form-control-lg  story-input"
                                                    name="lname" id="last_name" placeholder="Last Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="email">
                                            ...
                                            <h5 class="fw-bold text-capitalize  text-align"
                                                style="color:var(--text-color);">Email
                                            </h5>
                                            <form> <input type="email"
                                                    pattern="/^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/"
                                                    class="form-control form-control-lg story-input" name="username"
                                                    id="email" placeholder="Email" aria-required value="">
                                            </form>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="message">
                                            <div class="form-group" id="title">
                                                ...
                                                <textarea class="form-control form-control-lg story-input"
                                                    placeholder="Enter Your Message" type="text" name="msg" id="message"
                                                    aria-required style="padding-bottom:200px"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group" id="submit-btn">
                                            <button type="button" name="submit"
                                                class="user-profile-follow-button w-75 mx-0" id="submit_msg">Send
                                                Message</button>
                                        </div>
