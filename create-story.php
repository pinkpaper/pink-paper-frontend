            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 class="fw-bold text-capitalize mb-0 text-align" style="color:var(--text-color);">Write Story
                            </h1>
                            ...
                            <div class="row">
                                <div class="col-12 order-last order-lg-first">
                                    <div class="story-right-card shadow px-3 py-3 mb-3">
                                        <div class="d-grid">
                                            <button type="submit" class="btn button-primary" id="add_story">Published</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 ">
