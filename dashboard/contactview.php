                                    ...
                                    <h1>Contact details</h1>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group" id="title">
                                                ...
                                                <input readonly type="text" id="email" class="form-control" required="" value="<?php echo $row['username']; ?>" placeholder="Add the name" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">
