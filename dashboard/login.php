...
<head>
    ...
    <!-- Title -->
    <title>Login | Pink Paper Admin Dashboard</title>
                            ...
                            <div class="col">
                                ...
                                <form action="login.php" method="POST" autocomplete="">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control" id="email" name="username" aria-describedby="emailHelp" placeholder="Enter email" required value="<?php echo $username ?>">
                                    </div>
                                    <div class="form-group">
