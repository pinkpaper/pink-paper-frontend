...
<body onload="loader()">
                                        ...
                                        <div class="row">
                                            <div class="col-12 order-last order-lg-first">
                                                <div class="story-right-card shadow px-3 py-3 mb-3">
                                                    ...
                                                    <form id="myForm">
                                                        <div class="radio">
                                                            <input id="radio-1" name="radio" type="radio" value="Published" <?php echo $post_status !== 'schedule' ? 'checked' : '' ?>>
                                                            <label for="radio-1" class="radio-label" style="color:var(--text-color);">Publish now</label>
                                                        </div>
                                                        <div class="radio">
                                                            <input id="radio-2" name="radio" type="radio" value="Schedule" <?php echo $post_status === 'schedule' ? 'checked' : '' ?>>
                                                            <label for="radio-2" class="radio-label" style="color:var(--text-color);">Schedule</label>
                                                        </div>
                                                        <div class="radio">
                                                            <input id="radio-3" name="radio" type="radio" value="Draft" <?php echo $post_status === 'draft' ? 'checked' : '' ?>>
                                                    ...
                                                    <div class="d-grid mt-3 mb-1">
                                                        <button type="submit" class="user-profile-follow-button" id="update_story">Update
                                                            Story</button>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="row gap-2">
                                                                ...
                                                                <div class="col-12 tags-div">
                                                                    <h6 class="small mb-1" style="color:var(--text-color);">
                                                                        Add or change tags (up to 3) so readers know what your story is about:
                                                                    </h6>
                                                                    ...
                                                                    <button class="user-profile-follow-button my-2" data-bs-toggle="modal" data-bs-target="#commentRightModal">Add New
                                                                        Tag</button>
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-3-typeahead/4.0.1/bootstrap3-typeahead.min.js">
    </script>
