...
<header class="header" id="header-setting-style">
    <nav class="navbar navbar-expand-lg fixed-top" id="navbar-2">
        <div class="container py-2"><a href="./" class="navbar-brand text-uppercase font-weight-bold"><img
                    src="<?php echo $rowLogo['logo_image']; ?>" width='151px' alt='logo'></a>
            <div id="navbarSupportedContent" class="">


                <ul class="navbar-nav mx-auto text-center d-flex flex-row">
                    <li class="nav-item">
                        <a href="./" class="btn nav-button d-flex justify-content-center align-items-center"
                    ...
                    <li class="nav-item dropdown">
                        <?php 
                            ...
                            ?>
                        <a href="#" class="btn nav-button d-flex justify-content-center align-items-center"
                            id="dropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i
                                class="icon-user"></i></a>
                        <ul class="dropdown-menu shadow" aria-labelledby="dropdownMenuLink">
                            ...
                            <li><a class="dropdown-item text-center text-truncate"
                                    href="<?php echo $username; ?>"><?php echo '@'.$username; ?></a></li>
                            <li>
                        ...
                        <?php        
                                    ...
                                    echo '<a href="login-user-mm" class="btn nav-button d-flex justify-content-center align-items-center" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Login"><i class="icon-login"></i></a>';
                                }
                            ?>
                    </li>
                    <li class="nav-item">
                        <button class="btn nav-button" onclick="openSearchNav()" data-bs-toggle="tooltip"
                            data-bs-placement="bottom" title="Search"><i class="icon-magnifier"></i></button>
                    </li>
                    <li class="nav-item">
    ...
    <div class="d-flex flex-column align-content-around p-4">
        ...
        <div class="mb-5 sidenav-link">
            <?php
                        ...
                        ?>
            <a href="<?php echo $nav_link; ?>" class="text-capitalize px-0 py-2 mb-2"
                style="border-bottom:1px solid var(--gray-color-50);"><?php echo $nav_name; ?></a>
            <?php } ?>
