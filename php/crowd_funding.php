...
if (isset($_POST['project_address'])) {
    ...
    $query = "INSERT INTO `crowd_fund`(`crowd_fund_uuid`, `post_uid`, `user_address`, `pay_amount`, `pay_amount_in`, `txn_hash`, `project_address`, `from_ip`, `from_time`, `from_browser`) VALUES ('$crowd_fund_uuid','$post_uid','$user_address','$pay_amount','$pay_amount_in','$transactionHash','$project_address','$from_ip','$date_now','$from_browser')";
