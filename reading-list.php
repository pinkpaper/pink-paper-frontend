...
<body onload="loader()">
                                    ...
                                    <div class="inner-tag-container">
                                        <div class="tag-icon-name-div">
                                            <div class="tag-icon-name-inner-div">
                                                <div class="y">
                                                    <h1 class="tag-heading">Reading List</h1>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="sticky-lg-top">
                        <div class="h-100">
                            ...
                            <div class="user-profile-wrapper">
                                <a class="user-profile-inner" href="<?php echo $username; ?>" rel="noopener follow">
                                    <div class="user-profile-div">
                                        <?php
                                    if ($profile == '') {
                                        echo '<canvas class="avatar-image img-fluid rounded-circle user-profile-img" title="' . $name . '" width="88" height="88"></canvas>';
                                    } else {
                                        echo '<img src="uploads/profile/' . $profile . '" alt="" class="user-profile-img" width="88" height="88" loading="lazy">';
                                    }
                                    ?>
                                ...
                                <div class="tt l"></div>
                                <a class="user-profile-inner" href="<?php echo $username; ?>" rel="noopener follow">
                                    <h2 class="pw-author-name"><span class="il"><?php echo $name; ?></span></h2>
                                </a>
                                <div class="tu l"></div>
                                <span class="pw-follower-count">
                                    <a href="<?php echo $username; ?>" class="user-profile-inner-button">
                                        <?php 
                                $user_uid_follow = $user_uid;
                                ...
                                <p class="user-profile-para">
                                    <span class="user-profile-para-desc"><?php echo $bio; ?></span>
                                </p>
                                <div class="tx o w-100" id="follow_reload">
                                    <?php
                                        $user_uid2 = $user_uid ?? null;
                                        $sql20 = "SELECT * FROM follow WHERE following_user_uid = '$user_uid' 
                                        ...
                                        } else if ($user_uid == $user_uid_follow) {
                                            //echo '';
                                        } else if ($following_user_uid == $user_uid && $followed_user_uid == $user_uid_follow) {
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.loadmoreLatestPost', function() {
            ...
            $.ajax({
                type: 'POST',
                url: 'php/loadMoreData/loadMoreReadingList.php',
                data: {
                    row: row,
                    query: 'reading-list',
