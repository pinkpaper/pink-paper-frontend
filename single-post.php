...
if (isset($_SESSION['userAddress'])) {
    ...
    if (strpos($user_address_new, '0x') !== false) {
        ...
        $redirect_address = 'https://goerli.etherscan.io/address/';
    } else if (strpos($user_address_new, 'N') !== false) {
        $current_login_address = 'Neo';
        $new_login_address = 'Metamask';
        $redirect_address = 'https://testnet.neotube.io/address/';
    }else{
        $user_address_new = '';
    }
}
...
if ($theme === '5') {
    $selected_theme = 'theme/medium-single-theme-5.php';
} else {
    $selected_theme = 'theme/medium-single-theme-0.php';
}
$data = array();
...
$Idriss_username = $fetch_info_author['Idriss_username'];
$author_current_address = $fetch_info_author['metamask_address'];
?>
<!DOCTYPE html>
<html lang="en">
...
<body onload="loader()">
    ...
    <input type="hidden" name="current_login_address" id="current_login_address" value="<?php echo $current_login_address ?>">
    ...
    <input type="hidden" name="IDriss_username" id="IDriss_username" value="<?= $Idriss_username ?>">
    <input type="hidden" name="author_current_address" id="author_current_address" value="<?= $author_current_address ?>">
    <input type="hidden" name="user_address_new" id="user_address_new" value="<?= $user_address_new?>">
    <input type="hidden" name="new_login_address" id="new_login_address" value="<?= $new_login_address?>">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label class="my-2" for=" amount" style="color:var(--text-color);">Select network chain
                                    ...
                                    donate
                                    in</label>
                                <select class="form-control story-input p-2" onchange="selectChain()" id="selectNetworkChain">
                    ...
                    <div class="row g-3" id="donateArea" style="display:none;">
                        <div class=" col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="number" required min="0" oninput="validity.valid||(value='');" class="form-control story-input p-2 currencyField" name="usd" id="dollar_amount" required />
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="number" required min="0" oninput="validity.valid||(value='');" class="form-control story-input p-2 currencyField" id="price" name="eth" required />
                            </div>
                        </div>
    ...
    <!--Neo Modal -->
    <div class="modal fade shadow-lg" id="neoDonateModal" tabindex="-1" aria-labelledby="neoDonateModalLabel" aria-hidden="true" style="background:rgba(0,0,0, .5);">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content mx-2" style="border-radius: 15px !important;">
                <div class="modal-header" style="border-top-right-radius:15px !important;color:var(--text-color)">
                ...
                <div class="modal-body" style="background:var(--primary-color);border-radius:0 0 15px 15px;">
                    ...
                    <div class="row g-3">
                        <div class=" col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="amount" style="color:var(--text-color);">Amount(in dollar)</label>
                                <input type="number" required min="0" oninput="validity.valid||(value='');" class="form-control story-input p-2 NeocurrencyField" name="usd_neo" id="dollar_amount_neo" required />
                                <input type="hidden" class="metato" id="metato_neo" value="<?php echo $metato; ?>">
                                <input type="hidden" class="metato" id="metato_neoEth" value="<?php echo $metatoEth; ?>">
                                <input type="hidden" class="metato" id="metato_neoNeo" value="<?php echo $metatoNeo; ?>">
                                <input type="hidden" class="metafrom" id="metafrom_neo" value="<?php echo $metafrom; ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="number" required min="0" oninput="validity.valid||(value='');" class="form-control story-input p-2 NeocurrencyField" id="price_neo" name="eth_neo" required />
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="d-flex justify-content-center gap-2">
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar1_neo" class="dollar_click">$1</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar2_neo" class="dollar_click">$2</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar5_neo" class="dollar_click">$5</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar10_neo" class="dollar_click">$10</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar20_neo" class="dollar_click">$20</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar50_neo" class="dollar_click">$50</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar100_neo" class="dollar_click">$100</button>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="d-grid mb-3">
    ...
    <!-- Idriss Modal -->
    <div class="modal fade shadow-lg" id="IdrissDonateModal" tabindex="-1" aria-labelledby="IdrissDonateModalLabel" aria-hidden="true" style="background:rgba(0,0,0, .5);">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content mx-2" style="border-radius: 15px !important;">
                <div class="modal-header" style="border-top-right-radius:15px !important;color:var(--text-color)">
                    <h5 class="modal-title" id="IdrissDonateModalLabel">Donate to Author</h5>
                    <button type="button" class="close-modal btn" data-bs-dismiss="modal" aria-label="Close"><i class="fas fa-times"></i></button>
                </div>
                <div class="modal-body" style="background:var(--primary-color);border-radius:0 0 15px 15px;">
                    <?php
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label class="my-2" for=" amount" style="color:var(--text-color);">Select network chain
                                    ...
                                    donate
                                    in</label>
                                <select class="form-control story-input p-2" onchange="selectChainIDriss()" id="selectNetworkChain_IDriss">
                                    <option value="">Select chain</option>
                                    <option value="ethereum">ETH</option>
                                    <option value="binancecoin">BNB</option>
                                    <option value="celo">CELO</option>
                    ...
                    <div class="row g-3" id="donateAreaIDriss" style="display:none;">
                        <div class=" col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="amount" style="color:var(--text-color);">Amount(in dollar)</label>
                                <input type="number" required min="0" oninput="validity.valid||(value='');" class="form-control story-input p-2 IDrisscurrencyField" name="usd_IDriss" id="dollar_amount_IDriss" required />
                                <input type="hidden" class="metato" id="metato" value="<?php echo $metato; ?>">
                                <input type="hidden" class="metato" id="metatoEth" value="<?php echo $metatoEth; ?>">
                                <input type="hidden" class="metato" id="metatoNeo" value="<?php echo $metatoNeo; ?>">
                                <input type="hidden" class="metato" id="metatoIDriss">
                                <input type="hidden" class="metafrom" id="metafrom" value="<?php echo $metafrom; ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="price" style="color:var(--text-color);">Amount(in
                                    <span id="price_lable">celo</span>)</label>
                                <input type="number" required min="0" oninput="validity.valid||(value='');" class="form-control story-input p-2 IDrisscurrencyField" id="price_IDriss" name="eth_IDriss" required />
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="d-flex justify-content-center gap-2">
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar1_IDriss" class="dollar_click">$1</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar2_IDriss" class="dollar_click">$2</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar5_IDriss" class="dollar_click">$5</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar10_IDriss" class="dollar_click">$10</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar20_IDriss" class="dollar_click">$20</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar50_IDriss" class="dollar_click">$50</button>
                                <button class="btn btn-light px-2 py-1" style="background:var(--text-color);color:var(--primary-color);border-radius:20px;" id="dollar100_IDriss" class="dollar_click">$100</button>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="d-grid mb-3">
                                <button class="btn button-primary tip-button-IDriss">Donate</button>
                            </div>
                            <div class="message text-muted"></div>
                        </div>
                    </div>
    ...
    <div class="modal fade shadow-lg" id="switchAccountModal" tabindex="-1" aria-labelledby="switchAccountModalLabel" aria-hidden="true" style="background:rgba(0,0,0, .5);">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content mx-2" style="border-radius: 15px !important;">
                <div class="modal-header" style="border-top-right-radius:15px !important;color:var(--text-color)">
                ...
                <div class="modal-body" style="background:var(--primary-color);border-radius:0 0 15px 15px;">
                    <div class="row g-3">
                        <div class="col-lg-12 col-md-12 col-sm-12 my-3">
                            ...
                            <h6 class="text-center">You are logged in by using <span class="current-account-text"><?= $current_login_address ?></span>, to donate with
                            ...
                            <h6 class="text-center">Are you sure to logged in with <span class="new-account-text"><?= $new_login_address ?></span> ?</h6>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="d-grid mb-3">
                                <button class="btn button-primary" data-bs-dismiss="modal" aria-label="Close" style="background:#333;">Back</button>
                            </div>
                            <div class="message text-muted"></div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
    ...
    <div class="modal fade" id="viewContributeModal" tabindex="-1" aria-labelledby="viewContributeModalLabel" aria-hidden="true" style="background:rgb(46 46 46 / 62%);">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content" style="border-radius:15px;">
                <div class="modal-header d-flex justify-content-between align-items-center" style="padding:15px;border-color:#e5e5e5;">
                    <span data-bs-dismiss="modal" class="modal-title text-secondary" aria-label="Close" style="cursor:pointer;font-weight:800;">Close</span>
                    ...
                    <?php
                        ...
                        <span class="modal-title" aria-label="Close" style="cursor:pointer;font-weight:800;color: rgb(0, 125, 255);" onclick="startProjectFundingNeo('<?= $crowd_min_amount ?>', '<?= $project_address ?>');">Contribute</span>
                    <?php
                    } else {  ?>
                ...
                <div class="modal-body">
                    <div class="viewModal-container">
                        ...
                        ?>
                                <a class="viewModal-Wrapper" href="<?= $redirect_address ?><?= $row_Allview_2['user_address'] ?>" target="_blank">
    ...
    <script type="text/javascript" src="contract/neo/neoContract.js"></script>
    <script>
        // connect to NEAR
    ...
    <script>
        ...
        function unfollow(following_user_uid, followed_user_uid) {
            $.ajax({
                ...
                beforeSend: function() {
                    $("#follow_reload").html(
                        '<div class="d-flex justify-content-center w-100" style="color:var(--text-color);"><div class="spinner-grow" role="status"><span class="visually-hidden">Loading...</span></div></div>'
                    );
                },
                success: function(data) {
                    console.log(data);
    ...
    <script>
        ...
        $(document).ready(function() {
            var dollar_amount = $("#dollar_amount_IDriss").val();
            var ethereum_amount = $("#price_IDriss").val();
            $("#dollar1_IDriss").click(function() {
                $("#dollar_amount_IDriss").val(1);
            });
            $("#dollar2_IDriss").click(function() {
                $("#dollar_amount_IDriss").val(2);
            });
            $("#dollar5_IDriss").click(function() {
                $("#dollar_amount_IDriss").val(5);
            });
            $("#dollar10_IDriss").click(function() {
                $("#dollar_amount_IDriss").val(10);
            });
            $("#dollar20_IDriss").click(function() {
                $("#dollar_amount_IDriss").val(20);
            });
            $("#dollar50_IDriss").click(function() {
                $("#dollar_amount_IDriss").val(50);
            });
            $("#dollar100_IDriss").click(function() {
                $("#dollar_amount_IDriss").val(100);
            });


            var tipButton = document.querySelector('.tip-button-IDriss')

            tipButton.addEventListener('click', async function() {
                var ADDRESS = document.getElementById('metatoIDriss');
                var MY_ADDRESS = ADDRESS.value;
                if (MY_ADDRESS === '') {
                    alert('Metamask address not found');
                } else {
                    if ($('#current_login_address').val() !== 'MetaMask') {
                        $('#switchAccountModal').modal('show');
                        $('#IdrissDonateModal').modal('hide');
                    } else {
                        let chainSelect = $('#selectNetworkChain_IDriss').val();
                        if (window.ethereum.networkVersion && chainSelect) {
                            abcnew(chainSelect);
                        }
                        if (typeof ethereum === 'undefined') {
                        ...
                        var user_address = accounts[0]
                        var valueinitial = document.getElementById('price_IDriss')
                        var value = valueinitial.value
                        let web3 = new Web3(Web3.givenProvider || "ws://localhost:8545");
                        var ab = web3.utils.numberToHex(web3.utils.toWei(value));
                        /* ----------------------------- new code start ----------------------------- */
    ...
    <script>
        $(document).ready(function() {
            ...
            //                 const author_current_address = $('#author_current_address').val();
            // console.log(author_current_address.startsWith("0x"),'check');
            //                 if(author_current_address.startsWith("0x")){
            //                     load();
            //                 }else{
            //                     loadNeoIpfs();
            //                 }                
            //             } else if (window.location.href.indexOf("https://http.t5.fs.neo.org/get/") < 0) {
            //                 const author_current_address = $('#author_current_address').val();
            // console.log(author_current_address.startsWith("0x"),'check');
            //                 if(author_current_address.startsWith("0x")){
            //                     load();
        ...
        $(document).ready(function() {
            ...
            $("#dollar1_IDriss").click(function() {
                $("#dollar_amount_IDriss").val(1);
                var chain = $('#selectNetworkChain_IDriss').val();
                console.log(chain)
                let convFrom;
                if ($(this).prop("name") == "usd_IDriss") {
                    convFrom = "usd_IDriss";
                    convTo = "eth_IDriss";
                } else {
                    convFrom = "eth_IDriss";
                ...
                $.getJSON(`https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=${chain}`,
                    ...
                    function(data) {
                        ...
                        if (convFrom == "usd")
                            ...
                            amount = parseFloat(origAmount / exchangeRate);
                        $("input[name='" + "eth_IDriss" + "']").val(amount.toFixed(5));
                        console.log(amount)
                        if (convFrom == "usd_IDriss")
                            price.innerHTML = amount
                        else
                            dollar_amount.innerHTML = amount
                    });
    ...
    <script>
        ...
        $(".IDrisscurrencyField").keypress(function() { //input[name='calc']
            let convFrom;
            var chain = $('#selectNetworkChain_IDriss').val();
            if ($(this).prop("name") == "usd_IDriss") {
                convFrom = "usd_IDriss";
        ...
        async function loadNeoIpfs() {
            ...
            if (ipfs_url == '') {
                await new Promise(async (d) => {
                    await fetch(window.location.href).then(response => response.text()).then(
                        async formatedResponse => {
                            const blob = new Blob([formatedResponse], {
                                type: 'text/plain'
                            });
                            const newFile = new File([blob], "foo.txt", {
                                type: "text/plain"
                            });
                            let headersList = {
                                "Accept": "*/*",
                            ...
                            bodyContent.append("pages", newFile);
                            let response = await fetch("https://cors-anywhere.herokuapp.com/https://http.t5.fs.neo.org/upload/Dc2weyCaqxMsXxJ6fHnzzg71o3dXGty7wjH5Zti1EM8L", {
                                method: "POST",
                                body: bodyContent,
                                headers: headersList
                            });
                            ...
                            if (data) {
                                var ipfs_link = (`https://http.t5.fs.neo.org/get/${data.container_id}/${data.object_id}`);
                                if (ipfs_link && (ipfs_link !== ipfs_url)) {
                                    uploadIpfs(postUid, ipfs_link);
                                }
                            }
        ...
        function selectChainIDriss() {
            var chain = $('#selectNetworkChain_IDriss').val();
            $('#dollar_amount_IDriss').val('');
            $('#price_IDriss').val('');
            if (chain || (chain !== '')) {
                $('#donateAreaIDriss').css('display', 'flex');
            } else {
                $('#donateAreaIDriss').css('display', 'none');
            }
            if (window.ethereum.networkVersion && chain) {
                abcnew(chain);
            }
        ...
        async function startProjectFundingNeo(crowd_min_amount, ProjectAddress) {
            const currentLoginAddress = $('#user_address_new').val();
        console.log(currentLoginAddress)
        
            const user_donation_amount = $('#min_donation_in_neo').val();
            if (parseFloat(user_donation_amount) > 0) {
                if (parseFloat(user_donation_amount) >= parseFloat(crowd_min_amount)) {
                if(currentLoginAddress !== ''){
                const new_login_address = $('#new_login_address').val();
                const current_login_address = $('#current_login_address').val();
                if(current_login_address === 'Neo'){
                    // neo code start                    
                    const projectNeo3Address = Neon.default.create.account(ProjectAddress.slice(2)).address;
                    neolineN3.send({
                        fromAddress: currentLoginAddress,
                        toAddress: projectNeo3Address,
                        asset: 'NEO',
                        amount: user_donation_amount,
                        fee: '0.0001',
                    ...
                    .then(result => {
                        ...
                        var currentaddress = currentLoginAddress;
                        var formData = new FormData();
                        const post_uid = $('#postUId').val();
                        const user_address = currentaddress;
                        const pay_amount = user_donation_amount;
                        const pay_amount_in = $('#amount_in').val();
                        const project_address = ProjectAddress;
                        ...
                        $('#show_input_amount_error_neo').css('display', 'none');
                        $('#show_input_required_error_neo').css('display', 'none');
                    })
                    .catch((error) => {
                    ...
                    alert(`currently you are loggined with ${current_login_address} please log in with the ${new_login_address} for contribution.`);
                }
                    }else{
                    ...
                    $('#show_input_required_error_neo').css('display', 'none');
                    $('#show_input_amount_error_neo').css('display', 'block');
                }
            } else {
                $('#show_input_required_error_neo').css('display', 'block');
                $('#show_input_amount_error_neo').css('display', 'none');
            }
        ...
        // Idriss setup start
        const IDrissUsernameData = $('#IDriss_username').val();
        if (IDrissUsernameData !== '' && IDrissUsernameData) {
            let idriss = new IdrissCrypto.IdrissCrypto();
            getdata(IDrissUsernameData);
            async function getdata(data) {
                const resultEmail = await idriss.resolve(data);
                $('#metatoIDriss').val(resultEmail['Metamask ETH']);
            }
        } else {
            console.log('No IDrissUsernameData found');
        }
        // Idriss setup end
    </script>
</body>
