...
<head>
    ...
    <script src="https://content.pinkpaper.xyz/assets/feather/feather.min.js"></script>


    <!-- stylesheet -->
    <link href="https://content.pinkpaper.xyz/assets/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://content.pinkpaper.xyz/assets/toastr/toastr.min.css" rel="stylesheet">
    <link rel='stylesheet' href='https://content.pinkpaper.xyz/assets/css/success.css'>
    <link href="https://content.pinkpaper.xyz/assets/css/app.css" rel="stylesheet">
    <link href="https://content.pinkpaper.xyz/assets/css/loader.css" rel="stylesheet">
...
<body onload="loader()">
    ...
    <!-- Idriss Modal -->
    <div class="modal fade shadow-lg" id="IdrissDonateModal" tabindex="-1" aria-labelledby="IdrissDonateModalLabel"
        aria-hidden="true" style="background:rgba(0,0,0, .5);">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content mx-2" style="border-radius: 15px !important;">
                <div class="modal-header" style="border-top-right-radius:15px !important;color:var(--text-color)">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label class="my-2" for=" amount" style="color:var(--text-color);">Select network chain
                                    ...
                                    donate
                                    in</label>
                                <select class="form-control story-input p-2" onchange="selectChainIDriss()"
                                    id="selectNetworkChain_IDriss">
                                    <option value="">Select chain</option>
                                    <option value="ethereum">ETH</option>
                                    <option value="binancecoin">BNB</option>
                                    <!-- <option value="celo">CELO</option>
                    ...
                    <div class="row g-3" id="donateAreaIDriss" style="display:none;">
                        <div class=" col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="amount" style="color:var(--text-color);">Amount(in dollar)</label>
                                <input type="number" required min="0" oninput="validity.valid||(value='');"
                                    class="form-control story-input p-2 IDrisscurrencyField" name="usd_IDriss"
                                    id="dollar_amount_IDriss" required />
                                <input type="hidden" class="metato" id="metato" value="<?php echo $metato; ?>">
                                <input type="hidden" class="metato" id="metatoEth" value="<?php echo $metatoEth; ?>">
                                <input type="hidden" class="metato" id="metatoNeo" value="<?php echo $metatoNeo; ?>">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="price" style="color:var(--text-color);">Amount(in
                                    <span id="price_lable">celo</span>)</label>
                                <input type="number" required min="0" oninput="validity.valid||(value='');"
                                    class="form-control story-input p-2 IDrisscurrencyField" id="price_IDriss"
                                    name="eth_IDriss" required />
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="d-flex justify-content-center gap-2">
                                <button class="btn btn-light px-2 py-1"
                                    style="background:var(--text-color);color:var(--primary-color);border-radius:20px;"
                                    id="dollar1_IDriss" class="dollar_click">$1</button>
                                <button class="btn btn-light px-2 py-1"
                                    style="background:var(--text-color);color:var(--primary-color);border-radius:20px;"
                                    id="dollar2_IDriss" class="dollar_click">$2</button>
                                <button class="btn btn-light px-2 py-1"
                                    style="background:var(--text-color);color:var(--primary-color);border-radius:20px;"
                                    id="dollar5_IDriss" class="dollar_click">$5</button>
                                <button class="btn btn-light px-2 py-1"
                                    style="background:var(--text-color);color:var(--primary-color);border-radius:20px;"
                                    id="dollar10_IDriss" class="dollar_click">$10</button>
                                <button class="btn btn-light px-2 py-1"
                                    style="background:var(--text-color);color:var(--primary-color);border-radius:20px;"
                                    id="dollar20_IDriss" class="dollar_click">$20</button>
                                <button class="btn btn-light px-2 py-1"
                                    style="background:var(--text-color);color:var(--primary-color);border-radius:20px;"
                                    id="dollar50_IDriss" class="dollar_click">$50</button>
                                <button class="btn btn-light px-2 py-1"
                                    style="background:var(--text-color);color:var(--primary-color);border-radius:20px;"
                                    id="dollar100_IDriss" class="dollar_click">$100</button>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="d-grid mb-3">
    ...
    <script type="text/javascript" src="https://content.pinkpaper.xyz/assets/jquery/jquery-3.4.1.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js"></script>
    <script type="text/javascript" src="https://content.pinkpaper.xyz/assets/bootstrap/js/bootstrap.bundle.min.js">
    </script>
    <script type="text/javascript" src="https://content.pinkpaper.xyz/assets/avatar/jquery.letterpic.min.js">
    </script>
    <script src="https://content.pinkpaper.xyz/assets/toastr/toastr.min.js"></script>
    <script src='https://cdn.quilljs.com/1.2.3/quill.min.js'></script>

    <script type="text/javascript" src="./assets/js/app.js"></script>
    <script type="text/javascript" src="https://content.pinkpaper.xyz/assets/js/loader.js"></script>
...
"></script>
            ...
            if (MY_ADDRESS === '') {
                ...
                if ($('#current_login_address').val() !== 'MetaMask') {
                    ...
                    try {
                        ...
                        if (window.ethereum.networkVersion) {
                            const currentChainId = window.ethereum.networkVersion;
                            uploadDonate(post_uuid, user_address, MY_ADDRESS, value,
                                transactionHash,
                                currentChainId)
                        }
                    } catch (error) {
                    ...
                    /* ---------------------- transation success code start --------------------- */
                    function uploadDonate(post_uuid, user_address, MY_ADDRESS, value,
                        transactionHash,
                        currentChainId) {
                        console.log(post_uuid, user_address, MY_ADDRESS, value, transactionHash,
                            currentChainId);
    ...
    async function abcnew(chainValue) {
        var chainId = "1" // Ethereum Mainnet
        var HexchainId = "0x1"; // Hex Ethereum Mainnet
        var coinSymble = 'ETH';

        if (chainValue === "ethereum") {
            chainId = "1"; // Ethereum Mainnet
            HexchainId = "0x1"; // Hex Ethereum Mainnet
            coinSymble = 'ETH';
        } else if (chainValue === "binancecoin") {
            chainId = "56"; // BNB Mainnet
            HexchainId = "0x38"; // Hex BNB Mainnet
            coinSymble = 'BNB';
        } else if (chainValue === "celo") {
            chainId = "42220"; // CELO Mainnet
            HexchainId = "0xA4EC"; // Hex CELO Mainnet
            coinSymble = 'CELO';
        } else if (chainValue === "fantom") {
            chainId = "250"; // FANTOM Mainnet
            HexchainId = "0xFA"; // Hex FANTOM Mainnet
            coinSymble = 'FTM';
        } else if (chainValue === "avalanche-2") {
            chainId = "43114"; // AVAX Mainnet
            HexchainId = "0xA86A"; // Hex AVAX Mainnet
            coinSymble = 'AVAX';
        } else if (chainValue === "klay-token") {
            chainId = "8217"; // KLAY Mainnet
            HexchainId = "0x2019"; // Hex KLAY Mainnet
            coinSymble = 'KLAY';
        } else if (chainValue === "matic-network") {
            chainId = "137"; // MATIC Mainnet
            HexchainId = "0x89"; // Hex MATIC Mainnet
            coinSymble = 'MATIC';
        } else {
            chainId = "1"; // Ethereum Mainnet
            HexchainId = "0x1"; // Hex Ethereum Mainnet
