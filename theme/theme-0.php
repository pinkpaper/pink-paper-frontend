<section class="latest-post my-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-2 col-md-12 order-2 order-lg-1 style-position-1">
                            ...
                            <div
                                ...
                                <?php
                                    if (!isset($_SESSION['username'])) {
                                        ...
                                        echo '<button class="btn tip-button-2 fw-bold  mt-3" data-bs-toggle="modal" data-bs-target="#neoDonateModal"><img src="assets/images/n.png"><span class="ms-2">Donate<span class="d-lg-none">with Neo </span></span></button>';
                                            }}}                                 
                                    ?>
                                <?php
                                    }
            ...
            <div class="col-lg-7 col-md-12 order-1 order-lg-2 style-position-2">
            ...
            <div class="col-lg-3 col-md-12 order-3 order-lg-3 style-position-2">
                <div class="sidebar-item">
