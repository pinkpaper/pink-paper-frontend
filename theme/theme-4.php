<section class="latest-post my-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 order-1 order-lg-1 style-position-2 d-flex justify-content-center">
                <div class="card border-0 shadow-sm mb-4 w-100">
                    <div class="card-body">
                        ...
                        <div class="mb-3 d-inline d-lg-flex justify-content-start">
                            <?php
                                if ($featured_image2 == '') {
                                    echo '<img src="https://test.pinkpaper.xyz/assets/images/blogcms.com.png" alt="image" class="shadow img-fluid theme-4-main-image mx-2" style="border-radius:5px;">';
                                } else {
                                    echo '<img src="uploads/featuredImages/' . $featured_image2 . '" alt="image" class="shadow img-fluid theme-4-main-image mx-2" style="border-radius:5px;" onError="this.onerror=null;this.src=\'https://test.pinkpaper.xyz/assets/images/blogcms.com.png\';">';
                                }
                                ?>
                            <h2 class="fw-bold mx-lg-2 my-3 d-lg-flex justify-content-center align-items-center" style="color:var(--text-color);"><?php echo $post_title2; ?></h2>
                        </div>

                        <div class="mb-2 post-content post-content-theme-4" style="color:var(--gray-color);">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-12 order-2 order-lg-2 style-position-1">
                <div class="sidebar-item w-100">
                    <div class="">
                        <!-- user details -->
                        <div class="heading mb-4">
                            <h4 class="fw-bold">About Author<span>.</span></h4>
                        </div>
            ...
            <div class="col-lg-4 col-md-12 order-3 order-lg-3 style-position-2">
                <div class="sidebar-item w-100">
