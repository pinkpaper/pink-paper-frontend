        ...
        <div class="container">
            <div class="row-h">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h3 class="fw-bold text-capitalize mb-0 text-align d-none d-md-none d-lg-block d-sm-none "
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 	">
                        <div>
                            <ul class="nav nav-tabs flex-column "
                                style="text-align: left;text-decoration:none;margin-left: 92px;">
                        ...
                        <section id="about-you">
                            <div class="about-you" href="about-you">
                                <div class="row">
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <h5 class="fw-bold text-capitalize mb-0 text-align"
                                            style="color:var(--text-color);">Name
                                            <p></p>
                                            ...
                                            while($row = mysqli_fetch_array($result)){
                                                ?> <input class="form-control" required readonly id="name" type="text"
                                                    placeholder="Name" required value="<?php echo $row['name']?>">
                                        ...
                                        <div class="inputs d-flex justify-content-between align-items-center mt-4 gap-2">
                                            ...
                                            <button class='btn button-outline-primary' data-role="update"
                                                id='submitname' style="visibility: hidden;" type='button'>Save</a>
                                ...
                                <div class="row">
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        <h5 class="fw-bold text-capitalize mb-0 text-align"
                                            style="color:var(--text-color);">Bio
                                            <p></p>
                                            <div class="form-group mb-3">
                                                <input class="form-control" readonly id="Bio" type="text" name="bio"
                                                    placeholder="Bio" required value="<?php echo $bio ?>">
                                            </div>
                                        </h5>
                                        <div class="d-flex justify-content-between">
                                        ...
                                        <div class="inputs d-flex justify-content-between align-items-center mt-4 gap-2">
                                            ...
                                            <button class='btn button-outline-primary' id='save2'
                                ...
                                <div class="row">
                                    <div class=" col-12 d-flex justify-content-between align-items-center mb-4">
                                        <h5 class="fw-bold text-capitalize mb-0 text-align mx-2"
                                            style="color:var(--text-color);">Photo
                                            <p class="fw-bold text-capitalize mb-0 text-align"
                                                style="font-size: small;color:grey">Your photo appears on your Profile
                                    ...
                                    <div class="col-12 d-flex justify-content-end align-items-center">
                                        <form action="upload.php" method="post" enctype="multipart/form-data"
                                            ...
                                            class="align-items-center d-flex form justify-content-center">
                                        ...
                                        ">
                                            <input class="btn button-outline-primary" type="submit" value="Upload Image"
                                                name="submit" id="upload"
                                                style="display: inline-block;font-weight: 200;line-height: 1;justify-content:space-between;margin-left: 55px;visibility: hidden;">
                                        </form>
                        ...
                        <div class="social-section mt-5">
                            <div class="row">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <div class="email-settings">
                                        <h2 class="fw-bold text-capitalize mb-0 text-align=left"
                                            style="color:var(--text-color);">Social Settings
                                        </h2>
                                        <hr style="color: gray; width:29vw;padding-left: 15vw;">
                                        </hr>
                                    </div>
                            ...
                            <div class="row">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h5 class="fw-bold text-capitalize mb-0 text-align"
                                        style="color:var(--text-color);">Twitter
                                        <p></p>
                                        <div class="form-group mb-3">
                                            <input class="form-control" type="text" readonly id="social-twitter"
                                                name="twitter_url" placeholder="Enter Twitter full account url" required
                                                value="<?php echo $twitter_url ?>">
                                        </div>
                                    </h5>
                                    <div class="d-flex justify-content-between"></div>
                                    <div class="inputs d-flex justify-content-between align-items-center mt-4 gap-2">
                                        <button class="btn button-outline-primary" id='cancel-twitter'
                                            style="visibility: hidden;" type='reset'
                                            onclick="window.location.replace('user-settings.php')">Cancel</button>
                                        <button class='btn button-outline-primary' id='save-twitter'
                                            style="visibility: hidden;" type='submit'>Save</button>
                            ...
                            <div class="row">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h5 class="fw-bold text-capitalize mb-0 text-align"
                                        style="color:var(--text-color);">Instagram
                                        <p></p>
                                        <div class="form-group mb-3">
                                    ...
                                    <div class="d-flex justify-content-between"></div>
                                    <div class="inputs d-flex justify-content-between align-items-center mt-4 gap-2">
                                        <button class="btn button-outline-primary" id='cancel-instagram'
                                            style="visibility: hidden;" type='reset'
                                            onclick="window.location.replace('user-settings.php')">Cancel</button>
                                        <button class='btn button-outline-primary' id='save-instagram'
                                            style="visibility: hidden;" type='submit'>Save</button>
                            ...
                            <div class="row">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h5 class="fw-bold text-capitalize mb-0 text-align"
                                        style="color:var(--text-color);">LinkedIn
                                        <p></p>
                                        <div class="form-group mb-3">
                                    ...
                                    <div class="d-flex justify-content-between"></div>
                                    <div class="inputs d-flex justify-content-between align-items-center mt-4 gap-2">
                                        <button class="btn button-outline-primary" id='cancel-linkedin'
                                            style="visibility: hidden;" type='reset'
                                            onclick="window.location.replace('user-settings.php')">Cancel</button>
                                        <button class='btn button-outline-primary' id='save-linkedin'
                                            style="visibility: hidden;" type='submit'>Save</button>
                            ...
                            <div class="row">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h5 class="fw-bold text-capitalize mb-0 text-align"
                                        style="color:var(--text-color);">Facebook
                                        <p></p>
                                        <div class="form-group mb-3">
                                    ...
                                    <div class="d-flex justify-content-between"></div>
                                    <div class="inputs d-flex justify-content-between align-items-center mt-4 gap-2">
                                        <button class="btn button-outline-primary" id='cancel-facebook'
                                            style="visibility: hidden;" type='reset'
                                            onclick="window.location.replace('user-settings.php')">Cancel</button>
                                        <button class='btn button-outline-primary' id='save-facebook'
                                            style="visibility: hidden;" type='submit'>Save</button>
