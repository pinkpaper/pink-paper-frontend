...
if ($username != false) {
  ...
  if ($run_Sql) {
    ...
    $name2 = $fetch_info['name'];
    $username2 = $fetch_info['username'];
    $bio2 = $fetch_info['bio'];
    $profile2 = $fetch_info['profile'];
    $user_uid2 = $fetch_info['user_uid'];
                                    ...
                                    <div class="inner-tag-container">
                                        <div class="tag-icon-name-div">
                                            <div class="tag-icon-name-inner-div">
                                                <div class="y">
                                                    <h1 class="tag-heading">Your Stats</h1>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="content-panel m-lg-5 mt-3">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="mx-4">
                                    <h4 class="fw-bold text-center">Total Views</h4>
                                    <h5 class="fw-bold text-center" style="color:#1a8917">125</h5>
                                </div>
                                <a class="audience-button" href="audience-stats">Audience stats</a>
                            </div>
                            <h4 class="fw-bold text-center mt-5" style="color:var(--gray-color);">Post Stats</h4>
                        ...
                        <div>
                            <ul class="nav nav-tabs nav-pills mb-3" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="views-tab" data-bs-toggle="tab" href="#views5"
                                        role="tab" aria-controls="views5" aria-selected="true"
                                        style="border-radius:0;">Views</a>
                                </li>
                            </ul>
                            <div class="tab-content my-4" id="myTabContent">
                                <div class="tab-pane show active fade" id="views5" role="tabpanel"
                                    ...
                                    <div class="post-views">
                                        <?php
                                            ...
                                            AND(`stories`.`user_uid` = '$user_uid') LIMIT 0," . $limitViews;
                                                    ...
                                                    ?>
                                        <div class="story-post-card shadow-sm d-flex justify-content-between align-items-center px-3 py-3 mb-3 gap-2"
                                            style="border-radius:0;">
                                            <div>
                                                <h5 class="fw-bold article-dot text-capitalize mb-1"
                                                    style="color:var(--text-color); width:180px;white-space: nowrap;overflow:hidden !important;text-overflow: ellipsis;">
                                            ...
                                            <div class="d-flex justify-content-center align-items-center gap-2">
                                                ...
                                                <h5 class="fw-bold text-capitalize mb-1"
                                                    style="color:var(--text-color); display:inline-block;">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-12 text-center">
                                                    ...
                                                    <h6 class="fw-bold text-center" style="color:var(--gray-color)">You
                                                        have no data</h6>
                                                    <h6 class="text-center" style="color:var(--gray-color)"><a
                                                            href="create-story" class="text-link-3 fw-bold ">Write</a> a
                                                        story or <a href="./" class="text-link-3 fw-bold ">read</a> on
                                                        Blog CMS.</h6>
                                                </div>
                                            </div>
                                        </div>
