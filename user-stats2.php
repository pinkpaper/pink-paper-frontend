          ...
          <div class="post-views">
            ...
            AND(`stories`.`user_uid` = '$user_uid') LIMIT 0," . $limitViews;
                ...
                <div class="story-post-card shadow-sm d-flex justify-content-between align-items-center px-3 py-2 mb-3 gap-2">
                  <div>
                    <h5 class="fw-bold article-dot text-capitalize mb-1" style="color:var(--text-color); width:180px;white-space: nowrap;overflow:hidden !important;text-overflow: ellipsis;"><?php echo $row['post_title']; ?></h5>
                  </div>
