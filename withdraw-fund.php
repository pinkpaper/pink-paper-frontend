...
if (isset($_SESSION['userAddress'])) {
    ...
    if (strpos($user_address_new, '0x') !== false) {
        ...
        $currentUserAddress = $_SESSION['userAddress'];
...
<body onload="loader()">
    ...
    <input type="hidden" name="currentUserAddress" id="currentUserAddress" value="<?= $currentUserAddress ?>">
    <!-- loader start-->
                                ...
                                <div class="inner-tag-container">
                                    <div class="tag-icon-name-div">
                                        <div class="tag-icon-name-inner-div">
                                            <div class="y">
                                                <h1 class="tag-heading">Withdraw Fund</h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <div>
                                        <h1 class="fw-bold text-capitalize mb-0 text-align"
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <p class="text-center mb-0" style="color:var(--gray-color)"><span
                                                    id="result"></span>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        ?>
                                ...
                                <div class="write-story-div shadow story-right-card" style="border-radius:5px;">
                                    <!-- doner list start -->
                                    <div class="viewModal-container py-3 px-2">
                                        <?php
                        ...
                        ?>
                                        <a class="viewModal-Wrapper"
                                            href="<?= $redirect_address ?><?= $row_Allview_2['user_address'] ?>"
                                            target="_blank">
                                            <div class="viewModal-Wrapper-inner">
                                                                ...
                                                                <div class="viewModal-img-inner-in">
                                                                    <span class="img-setting-wrapper">
                                                                        <span class="img-setting-wrapper-in">
                                                                            <img class="img-setting-wrapper-in-img"
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            if (mysqli_num_rows($result_follow) > 0) {
                                                                                ...
                                                                                $profile_username_user = $row_follow['username'];                                                
                                                                                        if ($profile_img_user == '') {
                                                                                            echo '<canvas class="avatar-image img-fluid rounded-circle img-setting-wrapper-in-img2" title="' . $profile_name_user . '" width="20" height="20" style="border-radius:50%;width:20px;height:20px;"></canvas>';
                                                                                        } else {
                                                                                            echo '<img src="uploads/profile/' . $profile_img_user . '" alt="user-img" height="20" width="20" class="img-setting-wrapper-in-img2" style="border-radius:50%;" loading="lazy">';
                                                                                        }
                                                                                }}
                                                                        ?>
                                                                    </span>
                                                ...
                                                <div class="viewModal-inner-rank <?php echo $ii<=3 ?'topRanker':'' ?>">
                                                    #<?= $ii ?>
                                                </div>
                                            </div>
                                        </a>
                                ...
                                <div class="write-story-div shadow story-right-card d-flex justify-content-center align-items-center"
                                    ...
                                    <div class="my-5 d-flex justify-content-center align-items-center flex-column p-5"
                                        ...
                                        <h4 class="text-center my-4" style="color:var(--text-color);font-weight:800">No
                                            Contributor
                                            found</h4>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                                            ...
                                                            <div class="target-view-wrapper">
                                                                ...
                                                                <div style="font-size: 0.9rem;"><span
                                                                        style="font-size: 0.9rem;font-weight: 800;"><span
                                                                            ...
                                                                            id="amount_in_view">ETH</span></span>&nbsp;Target
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="story-right-card shadow px-3 py-3 mb-3">
                                                    <div
                                                        class="d-flex justify-content-center align-items-start flex-column my-2">
                                                        <div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <p style="font-size:0.9rem;word-break:break-all;"
                                                                ...
                                                                <span
                                                                    style="font-size:0.9rem;word-break:break-all;"><span
                                                        ...
                                                        <div>
                                                            ...
                                                            <p style="font-size:0.9rem;word-break:break-all;"><span
                                                                    id="recieved_eth">0.00</span>&nbsp;<?= $amount_in ?>
                                                            </p>
                                                        </div>
                                                        <div>
                                                            <h6 style="font-weight:800">Withdrawable Amount</h6>
                                                            <p style="font-size:0.9rem;word-break:break-all;"><span
                                                                    id="withdrawal_eth">0.00</span>&nbsp;<?= $amount_in ?>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="w-100">
                                            ...
                                            ?>
                                                        <button type="button"
                                                            class="user-profile-follow-button w-100 py-2"
                                                        ...
                                                        <button type="button"
                                                            class="user-profile-follow-button w-100 py-2"
                                                            id="withdraw-button-bnb">Withdraw
                                                            Amount</button>
                                                        <?php }else if($amount_in === 'NEO'){ ?>
                                                        <button type="button"
                                                            class="user-profile-follow-button w-100 py-2"
                                                            id="withdraw-button-neo">Withdraw
                                                            Amount</button>
                                                        <?php }else{  ?>
                                                        <button type="button"
                                                            class="user-profile-follow-button w-100 py-2">Wait
                                                            ...</button>
                                                        <?php } ?>
                                                        <?php }else{
                                                ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        if (!isset($_SESSION['username'])) {
                            echo '<button class="user-profile-follow-button-2"  onClick="login()">Add Tag</button>';
                        } else {
                            echo '<button class="user-profile-follow-button-2" id="submitTag">Add Tag</button>';
                        }
                        ?>
                    </div>
                </div>
...
// initialization of neo envoiremnet process start
    ...
    $(document).ready(function() {
        ...
        $('#withdraw-button-neo').click(async function() {            
            const Neo3Address = $('#currentUserAddress').val();
            ...
            .then(result => {
                var formData = new FormData();
                const post_uid = $('#postUId').val();
                const user_address = Neo3Address;
                const project_address = projectAddress;
        ...
        async function getBalanceNeo() {
            // neo user balance check start
                async function ReadTransationData(){ 
                                const Neo3Address = $('#currentUserAddress').val();
                                const scriptHash = (Neon.wallet.getScriptHashFromAddress(Neo3Address));
                                const LittleEndianHash = Neon.u.reverseHex(scriptHash);                    
                                neolineN3.invokeRead({
                                scriptHash: projectAddress,
                                operation: 'getTotalFundedAmount',
                                args: [],
                                signers: [
                                    {
                                        account: LittleEndianHash,
                                        scopes: 1
                                    }
                                ],
                            })
                            .then(result => {
                            const withdrawalEth =  result.stack[0].value
                            $('#withdrawal_eth').text(withdrawalEth);
                            $('#recieved_eth').text(withdrawalEth);
                            })
                            .catch((error) => {
                            const {type, description, data} = error;
                            switch(type) {
                        ...
                        setTimeout(ReadTransationData, 3000);
            // neo user balance check end
        }
